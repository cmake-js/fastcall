...
function assertDisposeFunction(disposeFunction) {
    assert(_.isFunction(disposeFunction) || disposeFunction === null, 
        'Missing disposeFunction argument. This functiion is intended to make ' +
        'another function that should release native resources. Please note that this dispose method has no ' +
