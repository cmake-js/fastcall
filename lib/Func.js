...
class Func {
    constructor(library, def, callMode, ptr) {
        ...
        this._other = null;
        this._otherMode = this.callMode === callMode.sync ? callMode.async : callMode.sync;
        this._ptr = ptr;
    }
    ...
    sync() {
        ...
        if (!this._other) {
            this._other = new Func(this.library, this, this._otherMode, this.ptr);
        }
        return this._other;
    }
